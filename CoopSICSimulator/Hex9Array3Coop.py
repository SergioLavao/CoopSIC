...
BS1.addSlaveBS( BS2 )
BS1.addSlaveBS( BS3 )
U1 = BS1.addUser([x_corner,y_corner])
...
BS6 = HexGrid.activateBS( 2, 2 )#Get BS via row, column

BS4.addSlaveBS( BS5 )
BS4.addSlaveBS( BS6 )
U2 = BS4.addUser([d,0])
U2_Slave1 = BS5.addUser([-x_corner,-y_corner]),
U2_Slave2 = BS6.addUser([-x_corner,y_corner]),

#SIC Group 3
BS7 = HexGrid.activateBS( 2, 4 )#Get BS via row, column
BS8 = HexGrid.activateBS( 2, 3 )#Get BS via row, column
BS9 = HexGrid.activateBS( 1, 3 )#Get BS via row, column

BS7.addSlaveBS( BS8 )
BS7.addSlaveBS( BS9 )
U3 = BS7.addUser([-d,0])
U3_Slave1 = BS8.addUser([x_corner,-y_corner]),
