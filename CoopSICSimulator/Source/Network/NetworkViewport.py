...
class NetworkViewport:
	...
	def __init__( self, networkSize, hex_radius=1 ):
		...
		dpg.create_viewport(title="Hex Grid Network", x_pos=0, y_pos=0, width=600, height=900)
		dpg.set_viewport_max_height(900)
		dpg.set_viewport_max_width(600)

		with dpg.window(tag="PrimaryWindow") as main_window:
