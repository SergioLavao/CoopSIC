...
function CRPairUsers( P, user1RelativePosition , user2RelativePosition, plotTitle )
    ...
    C_OMA_User1 = alpha.*log2(1 + P./(((d2x.^2 + d2y.^2).^0.5).*alpha));
    C_OMA_User2 = (1 - alpha).*log2(1 + P./(((d1x.^2 + d1y.^2).^0.5).*(1 - alpha)));
